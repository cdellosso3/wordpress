...
function customizer_library_nikkon_options() {
    ...
    $options['nikkon-note-layout'] = array(
        ...
        'section' => $section,
        'type'    => 'upsell',
        'description' => __( '<b>Premium Extra Features:</b><br />- Make Shop, Archive & Single pages full width<br />- Enable Blocks layout on any/all pages', 'nikkon' )
    );
    ...
    $options['nikkon-note-header'] = array(
        ...
        'section' => $section,
        'type'    => 'upsell',
        'description' => __( '<b>Premium Extra Features:</b><br />- Extra "Split Nav" header layout<br />- Remove WooCommerce cart', 'nikkon' )
    );
    ...
    $options['nikkon-slider-cats'] = array(
        ...
        'section' => $section,
        'type'    => 'text',
        'description' => __( 'Enter the ID\'s of the post categories you want to display in the slider. Eg: "13,17,19" (no spaces and only comma\'s)<br /><a href="https://kairaweb.com/documentation/setting-up-the-default-slider/" target="_blank"><b>Follow instructions here</b></a>', 'nikkon' )
    );
    ...
    $options['nikkon-blog-cats'] = array(
        ...
        'section' => $section,
        'type'    => 'text',
        'description' => __( 'Enter the ID\'s of the post categories you\'d like to EXCLUDE from the Blog, enter only the ID\'s with a minus sign (-) before them, separated by a comma (,)<br />Eg: "-13, -17, -19"<br />If you enter the ID\'s without the minus then it\'ll show ONLY posts in those categories.', 'nikkon' )
    );
    ...
    $options['nikkon-note-blog'] = array(
        ...
        'section' => $section,
        'type'    => 'upsell',
        'description' => __( '<b>Premium Extra Features:</b><br />- Set archives & search pages to full width<br />- Set blog single pages to full width', 'nikkon' )
    );
